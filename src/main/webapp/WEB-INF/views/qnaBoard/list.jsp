...
<body>
	...
	<div id="main_wrap">
		<div id="wrap">
			...
			<div class="paging">
				<a
					href="${conPath }/qna/list.do?pageNum=${paging.startPage - 1 eq 0 ? 1 : paging.startPage-1}"><img
				...
				<c:forEach var="j" begin="${paging.startPage }"
					...
					<c:if test="${j != paging.currentPage }">
						<a href="${conPath }/qna/list.do?pageNum=${j}">&ensp; ${j }
							&ensp;</a>
					</c:if>
				</c:forEach>
				<a
					href="${conPath }/qna/list.do?pageNum=${paging.endPage == paging.pageCnt ? paging.endPage : paging.endPage + 1 }"><img
