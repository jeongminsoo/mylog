...
INSERT INTO 
    DIARYBOARD(DNUM, DTITLE, MID, DTODOIN, DCONTENT, DHIT, DSTATUS, DDATE, DIP)
    VALUES(DIARYBOARD_SEQ.NEXTVAL, '오늘의 일기', 'bbb', NULL, '오늘은 날씨가 너무 좋아서 기분이 좋아요~ 행복합니다~~', 0, 1, '2022-07-28', '127.00.00.02');
INSERT INTO 
    DIARYBOARD(DNUM, DTITLE, MID, DTODOIN, DCONTENT, DHIT, DSTATUS, DDATE, DIP)
    VALUES(DIARYBOARD_SEQ.NEXTVAL, '여러분은 오늘 어떠셨나요?', 'aaa', NULL, '저는 오늘 시험을 보고 왔어요! 아파서 걱정했는데 나름 잘 본 거 같아요!', 0, 2, '2022-07-31', '127.00.00.02');
INSERT INTO 
    DIARYBOARD(DNUM, DTITLE, MID, DTODOIN, DCONTENT, DHIT, DSTATUS, DDATE, DIP)
...
INSERT INTO
    ...
    VALUES(DIARYREPLY_SEQ.NEXTVAL, 2, 'aaa', '김길동', '길동님 오늘 좋은 날씨만큼 좋은 일만 가득하세요~', 1, 1, SYSDATE, '127.0.0.02');
INSERT INTO
    DIARYREPLY(DRNUM, DNUM, MID, DRCONTENT, DRGROUP, DRINDENT, DRRDATE, DRIP)
